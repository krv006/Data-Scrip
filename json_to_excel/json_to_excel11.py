...
def process_json_file(input_file: str, output_file: str) -> None:
    ...
    try:
        ...
        with pd.ExcelWriter(output_file, engine='xlsxwriter') as writer:
            df.to_excel(writer, sheet_name='Fundraiser Data', index=False)

            # XlsxWriter ob'ektlarini olish
            worksheet = writer.sheets['Fundraiser Data']
...
if __name__ == "__main__":
    input_file = 'your_fundraiser_donations_information.json'
    output_file = 'your_fundraiser_donations_information.xlsx'
